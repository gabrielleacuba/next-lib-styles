...
export const Banner = () => {
  return (
    <>
      <div className="relative h-[660px]  bg-cover bg-center  bg-bannerImage before:absolute before:inset-0 before:h-full before:bg-shades-gray-100 before:opacity-40">
